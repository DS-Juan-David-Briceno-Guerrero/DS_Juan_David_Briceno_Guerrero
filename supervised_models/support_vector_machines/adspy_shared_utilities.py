...
def load_crime_dataset():
    ...
    crime = pd.read_table('/home/juan-david/Documents/data_science/travail_personnel/machine_learning_michigan_university/CommViolPredUnnormalizedData.txt', sep=',', na_values='?')
